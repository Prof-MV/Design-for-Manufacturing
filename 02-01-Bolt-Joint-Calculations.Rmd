## Strength of Bolt Joint Calculations {#chap-03-bolts}
...
```{r torque-angle-plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.cap="Torque-Angle Tightening Curve"}
library(ggplot2)
