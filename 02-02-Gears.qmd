...
ggplot() +
  ...
  annotate("text", x = 3, y = 2.3, label = "12 teeth\nω₁ = input", size = 3 * diagram_text_scale, color = "darkorange") +
  ...
  annotate("text", x = 6.5, y = 1.5, label = "20 teeth\nω₂ = output", size = 3 * diagram_text_scale, color = "steelblue") +

  ## Pitch circles (dashed)
  geom_point(aes(x = 4.15, y = 4), size = 3, color = "red") +
  annotate("text", x = 4.15, y = 3.3, label = "Pitch\nPoint", color = "red", size = 4 * diagram_text_scale) +

  ## Key principle box
  geom_rect(aes(xmin = 0.5, xmax = 4.5, ymin = 0.3, ymax = 1.5), fill = "lightyellow", color = "black") +
  annotate("text", x = 2.5, y = 1.1, label = "KEY PRINCIPLE:", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 2.5, y = 0.7, label = "Small gear drives large gear → Speed DOWN, Torque UP", size = 3.8 * diagram_text_scale) +
...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 6.7, label = "INPUT (Driver)", fontface = "bold", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 6.3, label = "15 teeth", size = 3 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 5.9, label = "1000 RPM", size = 3 * diagram_text_scale, color = "red") +
  annotate("text", x = 1.5, y = 5.5, label = "10 N·m torque", size = 3 * diagram_text_scale) +

  ## Output specifications
  geom_rect(aes(xmin = 6.3, xmax = 9.7, ymin = 5.5, ymax = 7), fill = "honeydew", color = "black") +
  annotate("text", x = 8, y = 6.7, label = "OUTPUT (Driven)", fontface = "bold", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 8, y = 6.3, label = "30 teeth", size = 3 * diagram_text_scale) +
  annotate("text", x = 8, y = 5.9, label = "500 RPM", size = 3 * diagram_text_scale, color = "darkgreen") +
  annotate("text", x = 8, y = 5.5, label = "20 N·m torque*", size = 3 * diagram_text_scale) +

  ## Gear ratio calculation
  geom_rect(aes(xmin = 3, xmax = 7, ymin = 0.5, ymax = 2), fill = "lightyellow", color = "black") +
  annotate("text", x = 5, y = 1.7, label = "Gear Ratio = 30/15 = 2:1", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 5, y = 1.2, label = "Speed: ÷2    Torque: ×2", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 5, y = 0.7, label = "*Assuming 100% efficiency", size = 2.5 * diagram_text_scale, fontface = "italic") +
...
ggplot() +
  ...
  annotate("text", x = 5.9, y = 3.8, label = "CCW", size = 3 * diagram_text_scale) +
...
ggplot() +
  ...
  ## Labels
  annotate("text", x = 5,    y = 4,   label = "SUN",    fontface = "bold", size = 3 * diagram_text_scale,   color = "darkorange") +
  annotate("text", x = 5,    y = 6.9, label = "Planet", size = 2.8 * diagram_text_scale,        color = "steelblue") +
...
ggplot() +
  ...
  annotate("text", x = 2.25, y = 4.3, label = "Conveyor Systems", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ## Motor + gearbox
  geom_rect(aes(xmin = 0.8, xmax = 1.8, ymin = 2, ymax = 3), fill = "gray70", color = "black") +
  annotate("text", x = 1.3, y = 2.5, label = "Motor +\nGearbox", size = 2.3 * diagram_text_scale) +
  ## Belt representation
  ...
  annotate("text", x = 2.25, y = 1.4, label = "Helical/Worm\nSpeed reduction", size = 2.5 * diagram_text_scale) +

  ## Mixer
  geom_rect(aes(xmin = 4.5, xmax = 8, ymin = 1, ymax = 4), fill = "white", color = "black", linewidth = 1) +
  annotate("text", x = 6.25, y = 4.3, label = "Industrial Mixers", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ## Bowl
  ...
  annotate("text", x = 6.25, y = 1.1, label = "Planetary\nOrbital mixing action", size = 2.5 * diagram_text_scale) +

  ## Packaging
  geom_rect(aes(xmin = 8.5, xmax = 12, ymin = 1, ymax = 4), fill = "white", color = "black", linewidth = 1) +
  annotate("text", x = 10.25, y = 4.3, label = "Packaging Equipment", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ## Indexing mechanism
...
ggplot() +
  ...
  annotate("text", x = 10.25, y = 1.3, label = "Harmonic drive\nZero backlash", size = 2.3 * diagram_text_scale, color = "tan") +
