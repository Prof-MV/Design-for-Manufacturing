...
ggplot() +
  ...
  annotate("text", x = 4.15, y = 3.3, label = "Pitch\nPoint", color = "red", size = 4) +

  ## Key principle box
  geom_rect(aes(xmin = 0.5, xmax = 4.5, ymin = 0.3, ymax = 1.5), fill = "lightyellow", color = "black") +
  annotate("text", x = 2.5, y = 1.1, label = "KEY PRINCIPLE:", fontface = "bold", size = 4) +
  annotate("text", x = 2.5, y = 0.7, label = "Small gear drives large gear → Speed DOWN, Torque UP", size = 3.8) +
...
knitr::include_graphics("images/Gear-terminology-with-defination-4-1.png")
```
...
if (knitr::is_html_output()) {
  knitr::include_graphics("images/Animated_two_spur_gears_1_2.gif")
} else {
  knitr::include_graphics("images/Animated_two_spur_gears_1_2.png")
}
```
...
if (knitr::is_html_output()) {
  knitr::include_graphics("images/Anim_engrenages_helicoidaux.gif")
} else {
  knitr::include_graphics("images/Anim_engrenages_helicoidaux.png")
}
```
...
knitr::include_graphics("images/Herringbone_gears_(Bentley,_Sketches_of_Engine_and_Machine_Details).jpg")
```
...
knitr::include_graphics("images/Gear-kegelzahnrad.png")
```
...
if (knitr::is_html_output()) {
  knitr::include_graphics("images/Worm_gear.gif")
} else {
  knitr::include_graphics("images/Worm_gear.png")
}
```
...
if (knitr::is_html_output()) {
  knitr::include_graphics("images/Rack_and_pinion_animation.gif")
} else {
  knitr::include_graphics("images/Rack_and_pinion_animation.png")
}
```
