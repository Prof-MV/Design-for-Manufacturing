...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 5.5, label = "1. FOAM PATTERN", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  annotate("text", x = 1.5, y = 3.7, label = "EPS\nFoam", size = 2.5 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 2, label = "Polystyrene\npattern created", size = 2.5 * diagram_text_scale, fontface = "italic") +

  # Stage 2: Coated Pattern
  annotate("text", x = 4.5, y = 5.5, label = "2. REFRACTORY COATING", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  annotate("text", x = 4.5, y = 2, label = "Ceramic coating\napplied & dried", size = 2.5 * diagram_text_scale, fontface = "italic") +

  # Stage 3: In Sand
  annotate("text", x = 7.5, y = 5.5, label = "3. EMBEDDED IN SAND", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  annotate("text", x = 7.5, y = 2, label = "Unbonded sand\ncompacted around", size = 2.5 * diagram_text_scale, fontface = "italic") +

  # Stage 4: Metal Poured
  annotate("text", x = 10.5, y = 5.5, label = "4. METAL REPLACES FOAM", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  annotate("text", x = 10.5, y = 2, label = "Foam vaporizes;\nmetal fills void", size = 2.5 * diagram_text_scale, fontface = "italic") +
...
ggplot() +
  ...
  annotate("text", x = 5, y = 1.5, label = "Dipped in slurry\n& stuccoed", size = 2.2 * diagram_text_scale, fontface = "italic") +

  # Stage 4: Dewax
  annotate("text", x = 7, y = 4.8, label = "4. DEWAX", fontface = "bold", size = 3 * diagram_text_scale) +
  ...
  annotate("text", x = 7, y = 1, label = "Wax\nmelted out", size = 2 * diagram_text_scale, color = "green4") +
  annotate("text", x = 7, y = 1.5, label = "Steam autoclave\nor flash fire", size = 2.2 * diagram_text_scale, fontface = "italic") +

  # Stage 5: Pour
  annotate("text", x = 9, y = 4.8, label = "5. POUR\nMETAL", fontface = "bold", size = 3 * diagram_text_scale) +
  ...
  annotate("text", x = 9, y = 1.5, label = "Preheated mold\nfilled with metal", size = 2.2 * diagram_text_scale, fontface = "italic") +

  # Stage 6: Finished
  annotate("text", x = 11, y = 4.8, label = "6. FINISHED\nCASTINGS", fontface = "bold", size = 3 * diagram_text_scale) +
  ...
  annotate("text", x = 11, y = 1.5, label = "Shell broken;\nparts cut off", size = 2.2 * diagram_text_scale, fontface = "italic") +
...
ggplot(defects, aes(x = frequency, y = severity, color = category)) +
  geom_point(size = 5) +
  geom_text(aes(label = defect), vjust = -1, size = 3.5 * diagram_text_scale) +
...
ggplot() +
  ...
  # Annotations
  annotate("text", x = 5, y = 3.3, label = "Shrinkage\nCavity", color = "red", fontface = "bold", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 5, y = 5.5, label = "Thick Section\n(Last to Solidify)", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 2.5, y = 3, label = "Thin\nSection", size = 3 * diagram_text_scale) +
  ...
  annotate("text", x = 5, y = 0.5, label = "Blue arrows show solidification direction (outside-in)",
           color = "blue", size = 3 * diagram_text_scale, fontface = "italic") +
