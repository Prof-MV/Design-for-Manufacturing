...
ggplot() +
  # BAD DESIGN (left)
  annotate("text", x = 2, y = 4.5, label = "POOR DESIGN", color = "red", fontface = "bold", size = 4 * diagram_text_scale) +
  ...
  annotate("text", x = 2.5, y = 2.5, label = "Sharp\nCorner", color = "red", size = 3 * diagram_text_scale) +
  geom_point(aes(x = 1.5, y = 2), color = "red", size = 3) +
  geom_point(aes(x = 1.5, y = 3), color = "red", size = 3) +

  # GOOD DESIGN (right)
  annotate("text", x = 7, y = 4.5, label = "GOOD DESIGN", color = "forestgreen", fontface = "bold", size = 4 * diagram_text_scale) +
  ...
  annotate("text", x = 7.5, y = 2.5, label = "Filleted\nCorner", color = "forestgreen", size = 3 * diagram_text_scale) +

  # Tool illustration
  annotate("text", x = 5, y = 2.5, label = "R = Tool\nRadius", size = 3 * diagram_text_scale) +
...
ggplot(tolerance_data, aes(x = tolerance_mm, y = relative_cost)) +
  ...
  geom_text(aes(label = process), vjust = -1, size = 3 * diagram_text_scale) +
